...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    /*
    Here, we are overriding the attemptAuthentication()
    methodd to validate the credentials and successfulAuthentication()
    to create the JWT token in case of successful Authorization.
     */
    @Override
