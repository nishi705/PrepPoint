...
Animal Shelter
	...
	- Holds Dogs & Cat
	- Operates on FIFO
	- Can't select any given Pet
	- They can only select a dog or cat
	- They get either the oldest pet available or the oldest dog / cat available
...
boolean function(TreeNode head1,TreeNode head2){
     if(head1==null && head2==null)return  true;
    if(head1 == null || head2==null)return false;
    
  
        if(head1.val == head2.val){
            function(head1.left,head2.left);
            function(head1.right,head2.right)
